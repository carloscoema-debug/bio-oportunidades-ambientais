...
- QUÍMICA INDUSTRIAL / ENGENHARIA QUÍMICA (Químico(a) Industrial, registro no CRQ, controle de qualidade química, BPF — Boas Práticas de Fabricação): formação em QUÍMICA, não em meio ambiente. Engenharia Química NÃO é um dos cursos do BIO (só Gestão Ambiental, Engenharia Sanitária e Ambiental, Saneamento Ambiental, Técnico em Meio Ambiente, Técnico em Saneamento). O cargo citar "legislação ambiental" ou "normas ambientais" como UMA das responsabilidades (comum em controle de qualidade industrial, ao lado de ISO e BPF) NÃO torna a vaga aderente — a formação exigida continua sendo química, não ambiental. => "descartar".
